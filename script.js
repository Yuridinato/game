...
/* ==========================================================================
   ...
   ========================================================================== */
function buildCells() {
  // Posicionamento aleatório do bônus (+2 pts) e da bomba (-2 pts)
...
function handleTimeout() {
  ...
  toast.innerHTML = `<div class="result-icon-big">⏰</div><div class="result-info"><div class="result-title">Tempo esgotado!</div><div class="result-sub">Nenhum grupo pontua nesta rodada.</div></div><div class="result-pts zero">0</div>`;
  body.appendChild(toast);
